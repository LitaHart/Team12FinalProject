...
public class HospitalController {
	...
	public String urlMethod(HttpServletRequest req , Membert2 m2 ) throws Exception {		
	...
	public void hospitalReserveCancleDo(HttpServletRequest req ,Membert2 m2) {
		
		String aaa = req.getParameter("RESERVE_HOSPITALNO");
		System.out.println(aaa);
		lDAO.loginCheck(req);
		//HDAO.hospitalReserveCancle(req,m2);
	}
